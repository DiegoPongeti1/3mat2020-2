/*
   ...
   Esssa função deve receber dois argumentos:
   1) O elemento da posição atual no loop for
   2) O elemento da posição seguinte no loop for 
   E deve retornar: 
   1) true, caso o elemento da pisição atual seja maior que o da posição seguinte; ou
   2) salse, caso o contrário
    ...
    do {
        ...
        for(let i = 0; i <= vetor.length -2; i++){
            ...
            if(fnComp(vetor[i], vetor[i + 1])){
                // Fazer a troca entre os elementos usando DESTRUTURAÇÃO (destructuring)
